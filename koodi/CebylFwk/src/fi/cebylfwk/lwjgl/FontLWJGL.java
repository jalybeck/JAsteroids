...
public class FontLWJGL implements fi.cebylfwk.graphics.Font {
	...
	public FontLWJGL(Font font, boolean antiAlias, char[] additionalChars) {
		this.font = font;
	...
	public int loadImage(BufferedImage bufferedImage) {
	    try {
		    ...
		    int internalFormat =  GL11.GL_RGB8;//GL11.GL_RGBA;//
                    int format = GL11.GL_RGBA;//EXTAbgr.GL_ABGR_EXT;//
	...
	public boolean isSupported(String fontname) {
		Font font[] = getFonts();
